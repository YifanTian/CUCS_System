...
router.get('/getImages', function(req, res){
    ...
    // });
    try {
        const profiles = await Image.find().populate('userName', ['title', 'info']);
        res.json(profiles);
      } catch (err) {
  ...
  router.get('/getImagesCount', function(req, res){
  ...
  router.post('/uploadImage', upload.single('uploadPhoto'), function (req, res) {
    let image = new Image;
  ...
  router.post('/deletPost', function(req, res){
    // console.log(req);
